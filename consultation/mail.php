...
$to = "soudan@fukui-knock-luv.com";

//送信元メールアドレス ※設置先サイトと同じドメイン推奨
$from = "soudan@fukui-knock-luv.com";
...
$jumpPage = 0;
$thanksPage = "https://fukui-knock-luv.com/consultation/thanks.html";
		...
		<?php }else{ ?>
			<div class="wrapper">
				<div class="container container--notepad" align="center">
					個別相談送信フォーム
						<br><small>個別相談のフォームをご入力いただきありがとうございます。</small>
						<br><small>改めて担当者よりご連絡いたします。</small>
